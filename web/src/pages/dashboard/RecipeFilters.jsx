...
import { Form, Input, InputNumber, Select, Row, Col, Space, Button, Typography, Flex } from "antd";
        ...
        <Row gutter={[12, 8]}>
          ...
          <Col xs={24} sm={12} md={8}>
            <Form.Item name="state" label="State">
              <Select placeholder="Select state" allowClear showSearch optionFilterProp="children">
                {stateOptions.map((s) => (
